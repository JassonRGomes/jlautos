                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                    {favorites.map((vehicle) => {
                      ...
                      return (
                        ...
                        >
                          <Link href={`/details?id=${vehicle.id}`} onClick={(e) => { e.preventDefault(); window.location.href = `/details?id=${vehicle.id}`; }} className="relative aspect-video block bg-zinc-950 overflow-hidden">
                            <Image
                              src={img}
                        ...
                        <div key={booking.id} className="relative pl-8">
                          ...
                          <div className="bg-card border border-card-border p-5 rounded-lg flex flex-col md:flex-row md:items-center justify-between gap-4">
                            ...
                            <div className="flex items-center gap-4 flex-shrink-0 border-t md:border-t-0 pt-3 md:pt-0">
                              ...
                              <Link
                                href={`/details?id=${booking.vehicleId}`} onClick={(e) => { e.preventDefault(); window.location.href = `/details?id=${booking.vehicleId}`; }}
                        ...
                        >
                          ...
                          <div className="space-y-2">
                            ...
                            <div className="flex justify-end pt-2 mt-2 border-t border-card-border/50">
                              <Link
                                href={`/details?id=${offer.vehicleId}`} onClick={(e) => { e.preventDefault(); window.location.href = `/details?id=${offer.vehicleId}`; }}
                                className="text-xs text-accent hover:text-accent-hover font-bold uppercase tracking-wider flex items-center gap-1"
                              >
