 ...
 */
const sendNewBookingAlertToAgency = async (params) => {
...
exports.sendNewBookingAlertToAgency = sendNewBookingAlertToAgency;
/**
 * Send SMS to the customer when their booking is CONFIRMED or CANCELLED.
 */
const sendBookingStatusSMSToCustomer = async (params) => {
...
exports.sendBookingStatusSMSToCustomer = sendBookingStatusSMSToCustomer;
/**
 * Clear the deduplication set — useful for testing.
 */
const clearSMSDedupeCache = () => {
    sentSet.clear();
    console.log('[SMS Service] Deduplication cache cleared.');
};
exports.clearSMSDedupeCache = clearSMSDedupeCache;
/**
 * Health check — returns whether Twilio is configured.
 */
const getSMSServiceStatus = () => ({
    enabled: SMS_ENABLED,
